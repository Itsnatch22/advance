        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <motion.div
              ...
              className="rounded-3xl bg-white p-8 shadow-2xl lg:p-10 dark:bg-neutral-900"
            >
              <div className="mb-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register("name")}
                    className={`w-full rounded-xl border px-4 py-3 transition focus:ring-2 focus:outline-none ${
                      errors.name
