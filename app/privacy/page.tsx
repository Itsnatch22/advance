...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-16 px-6">
      ...
      >
        <h1 className="text-4xl font-bold dark:text-white text-gray-900 mb-6">Privacy Policy</h1>
        <p className="text-gray-600 dark:text-white mb-12">
          Effective Date: {new Date().toLocaleDateString()}
        </p>

        {/* Section 1 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">1. Introduction</h2>
        ...
        {/* Section 2 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">2. Information We Collect</h2>
        ...
        {/* Section 3 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">3. How We Use Your Information</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 4 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">4. Sharing of Information</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 5 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">5. Data Security</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 6 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">6. Your Rights</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 7 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">7. Changes to this Policy</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 8 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">8. Contact Us</h2>
        <p className="text-gray-600 dark:text-white">
          If you have any questions about this Privacy Policy, please contact us at{' '}
          <a href="mailto:privacy@kaziadvance.com" className="text-green-600 dark:text-black underline">
