  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-6">
      ...
      >
        ...
        {/* Licensing */}
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">1. Licensing & Approvals</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">2. Financial Regulations</h2>
        <p className="text-gray-600 mb-6">
        ...
        {/* Data Privacy */}
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">3. Data & Privacy Regulations</h2>
        <p className="text-gray-600 mb-6">
        ...
        {/* Disputes */}
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">6. Dispute Resolution</h2>
        <p className="text-gray-600 mb-6">
        ...
        {/* Updates */}
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">7. Policy Updates</h2>
        <p className="text-gray-600 mb-6">
        ...
        {/* Contact */}
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">8. Contact Compliance</h2>
