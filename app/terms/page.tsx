  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-16 px-6">
      ...
      >
        ...
        {/* Section 1 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">1. Acceptance of Terms</h2>
        ...
        {/* Section 2 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">2. Eligibility</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 3 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">3. Services Provided</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 4 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">4. User Responsibilities</h2>
        <ul className="list-disc list-inside text-gray-600 dark:text-white space-y-2 mb-6">
        ...
        {/* Section 5 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">5. Fees and Payments</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 6 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">6. Limitation of Liability</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 7 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">7. Termination</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 8 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">8. Governing Law</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 9 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">9. Changes to Terms</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 10 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">10. Contact Us</h2>
        <p className="text-gray-600 dark:text-white">
          For questions about these Terms, contact us at{' '}
          <a href="mailto:legal@kaziadvance.com" className="text-green-600 dark:text-black underline">
