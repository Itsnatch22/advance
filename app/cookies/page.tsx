  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black py-16 px-6">
      ...
      >
        ...
        {/* Section 1 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">1. What Are Cookies?</h2>
        ...
        {/* Section 2 */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">2. Types of Cookies We Use</h2>
        ...
        {/* Section 3 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">3. How We Use Cookies</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 4 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">4. Third-Party Cookies</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 5 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">5. Managing Cookies</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 6 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">6. Updates to This Policy</h2>
        <p className="text-gray-600 dark:text-white mb-6">
        ...
        {/* Section 7 */}
        <h2 className="text-2xl font-semibold dark:text-white text-gray-800 mt-8 mb-4">7. Contact Us</h2>
