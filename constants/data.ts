...
export const techPartners = [
  ...
  { 
    ...
    blurb: "Platform for frontend developers, providing the speed and reliability.", 
  ...
  { 
    ...
    blurb: "Cloud communications platform for building SMS, Voice & Messaging applications.", 
