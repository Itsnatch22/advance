...
export default function ProblemStatement() {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden bg-gray-50 py-16 sm:py-20 lg:py-24"
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 sm:gap-16 sm:px-6 lg:grid-cols-2 lg:gap-20">
        ...
        >
          <div className="group relative">
            <Image
              ...
              width={550}
              height={400}
              className="rounded-xl border border-green-100 object-cover shadow-2xl"
            />
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h2 className="font-serif text-3xl leading-tight font-bold text-gray-900 sm:text-4xl md:text-5xl">
