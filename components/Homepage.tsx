...
export default function Hero() {
    ...
    return(
        <section className="relative min-h-screen flex items-center justify-center text-white bg-[url('/homepage/background.jpg')] bg-cover bg-center px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
            <div className="absolute inset-0 bg-gradient-to-r from-green-700/90 to-transparent"></div>
            <div
            className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-w-7xl mx-auto">
                <div
                ref={textRef}
                className="space-y-4 sm:space-y-6 relative z-10">
                    ...
                    >
                        <Link href="/register"
                        className="flex items-center justify-center gap-2 dark:bg-black bg-green-600 text-white px-6 py-3 rounded-xl text-base sm:text-lg font-medium hover:bg-green-700 transition"
                        >
                            Get Started Now
                            <BiChevronRight className="w-5 h-5 "/>
                        </Link>
                        <Link href="/employers"
                        className="bg-transparent gap-2 flex items-center justify-center border-green-500 border px-6 py-3 rounded-xl text-base sm:text-lg font-medium hover:bg-green-50 text-white hover:text-green-700 ease-in-out transition-colors"
                        >
                            For Employers
                            <BiChevronRight className="w-5 h-5"/>
                        </Link>
