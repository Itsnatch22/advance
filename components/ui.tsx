...
export const Input: React.FC<InputProps> = ({
  ...
  <div className="w-full">
    ...
    <input
      className={`h-10 w-full rounded-lg border bg-white px-3 transition-all focus:ring-2 focus:ring-indigo-500 focus:outline-none ${error ? "border-red-300 focus:ring-red-200" : "border-slate-300"} ${className}`}
      {...props}
    />
...
export const TableRow: React.FC<{
  ...
  <tr
    className={`border-b border-slate-100 transition-colors last:border-0 hover:bg-slate-50/50 ${className}`}
  >
    {children}
  </tr>
);
