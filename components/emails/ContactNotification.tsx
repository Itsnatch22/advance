    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          ...
          <Text style={subtitle}>Earned Wage Access for Employees Across Africa</Text>
        </Section>
        ...
        <Section style={footer}>
          <Text style={footerText}>
            This message was sent via the EaziWage contact form. 
...
const header = { backgroundColor: '#16a34a', padding: '30px', textAlign: 'center' as const, borderRadius: '8px 8px 0 0' };
const h1 = { color: '#ffffff', margin: '0', fontSize: '24px' };
const subtitle = { color: '#d1fae5', margin: '5px 0 0', fontSize: '14px' };
const content = { backgroundColor: '#ffffff', padding: '30px', borderRadius: '0 0 8px 8px' };
const row = { margin: '20px 0' };
const halfColumn = { width: '48%', display: 'inline-block' };
const label = { color: '#6b7280', fontSize: '14px', fontWeight: '600', margin: '0 0 5px' };
...
const footer = { marginTop: '30px', paddingTop: '20px', borderTop: '1px solid #e5e7eb' };
const footerText = { color: '#6b7280', fontSize: '12px', textAlign: 'center' as const, margin: '5px 0' };